...
// Сообщения об ошибках на русском языке
    'custom' => [
        ...
        'regphone' => [
            ...
            'integer' => 'В поле телефон должны быть только цифры ',
            'unique' => 'Пользователь с таким телефоном существует',

        ],
        'regemail' => [
            'required' => 'Укажите почтовый ящик',
            'email' => 'Некорректный почтовый ящик',
            'unique' => 'Пользователь с email существует',

        ],
        'pwd1' => [
            'same' => 'Пароли не совпадает',
            'required' => 'Пароль должен задан',
            'min' => 'Пароль должен быть больше :min',
